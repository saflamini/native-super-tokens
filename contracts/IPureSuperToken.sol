...
import { TokenInfo } from "@superfluid-finance/ethereum-contracts/contracts/interfaces/tokens/TokenInfo.sol";
...
/**
 * @title Pure Super token (Superfluid Token + ERC20 + ERC777) interface
 * @author Superfluid
 */
interface IPureSuperToken is ISuperfluidToken, TokenInfo, IERC20, IERC777 {
